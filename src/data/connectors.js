...
export const CONNECTOR_TYPES = {
  cause_effect: {
    ...
    color: 'text-red-400',
    words: [
      { word: 'consequently', weight: 1.0 },
      { word: 'therefore', weight: 1.0 },
      { word: 'hence', weight: 1.0 },
      { word: 'thus', weight: 1.0 },
      { word: 'accordingly', weight: 1.0 },
      { word: 'as a result', weight: 1.0 },
      { word: 'because', weight: 1.0 },
      { word: 'so', weight: 1.0 },
      { word: 'for this reason', weight: 1.0 },
    ],
  },
  contrast: {
    ...
    color: 'text-blue-400',
    words: [
      { word: 'however', weight: 1.0 },
      { word: 'conversely', weight: 1.0 },
      { word: 'on the other hand', weight: 1.0 },
      { word: 'whereas', weight: 1.0 },
      { word: 'on the contrary', weight: 1.0 },
      { word: 'nevertheless', weight: 1.0 },
      { word: 'nonetheless', weight: 1.0 },
      { word: 'yet', weight: 1.0 },
      { word: 'still', weight: 1.0 },
    ],
  },
  addition: {
    label: 'Addition',
    ...
    words: [
      { word: 'furthermore', weight: 1.0 },
      { word: 'moreover', weight: 1.0 },
      { word: 'in addition', weight: 1.0 },
      { word: 'further', weight: 1.0 },
      { word: 'also', weight: 1.0 },
      { word: 'besides', weight: 1.0 },
    ],
  },
  concession: {
    label: 'Concession',
    ...
    words: [
      { word: 'although', weight: 1.0 },
      { word: 'even so', weight: 1.0 },
      { word: 'notwithstanding', weight: 1.0 },
      { word: 'granted', weight: 1.0 },
      { word: 'in spite of', weight: 1.0 },
      { word: 'despite', weight: 1.0 },
      { word: 'while', weight: 1.0 },
      { word: 'even though', weight: 1.0 },
    ],
  },
  condition: {
    label: 'Condition',
    ...
    words: [
      { word: 'if', weight: 1.0 },
      { word: 'unless', weight: 1.0 },
      { word: 'provided that', weight: 1.0 },
    ],
  },
  time_sequence: {
    label: 'Time & Sequence',
    color: 'text-cyan-400',
    words: [
      { word: 'subsequently', weight: 1.0 },
      { word: 'meanwhile', weight: 1.0 },
      { word: 'first', weight: 1.0 },
      { word: 'then', weight: 1.0 },
      { word: 'finally', weight: 1.0 },
      { word: 'afterward', weight: 1.0 },
    ],
  },
  comparison: {
    ...
    color: 'text-pink-400',
    words: [
      { word: 'likewise', weight: 1.0 },
      { word: 'similarly', weight: 1.0 },
      { word: 'in the same way', weight: 1.0 },
      { word: 'just as', weight: 1.0 },
    ],
  },
};
